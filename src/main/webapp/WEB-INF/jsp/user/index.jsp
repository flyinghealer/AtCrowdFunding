...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/user/add.html'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
          <div class="table-responsive">
          	<!-- 这里是展示用户数据的地方，为了同时删除多个用户时获取多个用户信息所以添加了from表单 -->
            <form id="userForm">
	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function deleteUsers(){
            	...
            	if(boxes.length==0){
            		layer.msg("请先选择要删除的用户信息",{time:1000,icon:5,shift:6},function(){

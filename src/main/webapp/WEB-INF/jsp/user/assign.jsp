        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#left2RightBtn").click(function(){
			    	...
			    	if(opts.length==0){
			    		layer.msg("请先选择要分配的角色数据",{time:1000,icon:5,shift:6},function(){
			    		...
			    		$.ajax({
			    			...
			    			success:function(result){
			    				if(result.success){
			    					...
			    					layer.msg("分配角色数据成功",{time:1000,shift:6},function(){
			    ...
			    $("#right2LeftBtn").click(function(){
			    	...
			    	if(opts.length==0){
			    		layer.msg("请先选择要取消分配的角色数据",{time:1000,icon:5,shift:6},function(){
			    		...
			    		$.ajax({
			    			...
			    			success:function(result){
			    				if(result.success){
			    					...
			    					layer.msg("取消分配角色数据成功",{time:1000,shift:6},function(){
